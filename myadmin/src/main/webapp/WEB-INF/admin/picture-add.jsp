...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/lib/jquery/jquery-3.2.1.min.js"></script>
    <!--引入JShttp://cdn.staticfile.org/webuploader/0.1.0/Uploader.swf-->
    <script type="text/javascript" src="<%=path%>/lib/webuploader/0.1.5/webuploader.js"></script>
</head>
<body>
    ...
    $(function(){
        ...
        var uploader;
         uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '<%=path%>/picture/fileUpload',
    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '<%=path%>/picture/uploadPicture',
                // runtimeOrder: 'flash',
